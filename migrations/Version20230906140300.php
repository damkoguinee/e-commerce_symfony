 ...
 */
final class Version20230906140300 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE dimensions CHANGE valeur_dimension valeur_dimension VARCHAR(10) NOT NULL');
    }
}
